...
namespace Nop.Plugin.Api.WebHooks
{
    ...
    public class FilterProvider : IWebHookFilterProvider
    {
        private readonly Collection<WebHookFilter> filters = new Collection<WebHookFilter>
        {
            ...
            new WebHookFilter
            {
                Name = WebHookNames.ProductsUnmap,
                Description = "A product has been unmapped from the store."
            },
            ...
            new WebHookFilter
            {
                Name = WebHookNames.CategoriesUnmap,
                Description = "A category has been unmapped from the store."
            },
            ...
            new WebHookFilter
            {
                Name = WebHookNames.ProductCategoryMapsCreate,
                Description = "A product category map has been created."
            },
            new WebHookFilter
            {
                Name = WebHookNames.ProductCategoryMapsUpdate,
                Description = "A product category map has been updated."
            },
            new WebHookFilter
            {
                Name = WebHookNames.ProductCategoryMapsDelete,
                Description = "A product category map has been deleted."
            },
            ...
            new WebHookFilter
            {
                Name = WebHookNames.NewsLetterSubscriptionCreate,
                Description = "A news letter subscription has been created."
            },
            new WebHookFilter
            {
                Name = WebHookNames.NewsLetterSubscriptionUpdate,
                Description = "A news letter subscription has been updated."
            },
            new WebHookFilter
            {
                Name = WebHookNames.NewsLetterSubscriptionDelete,
                Description = "A news letter subscription has been deleted."
            }
        };
